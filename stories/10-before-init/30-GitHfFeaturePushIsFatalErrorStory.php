...
//     we can run 'git hf feature push',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature push` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature push');
