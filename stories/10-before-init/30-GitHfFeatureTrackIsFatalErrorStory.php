...
//     we can run 'git hf feature track',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature track` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature track');
