...
//     we can run 'git hf feature pull',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature pull` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature pull');
