...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf hotfix push` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf hotfix push');
