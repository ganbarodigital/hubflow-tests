...
//     when we run 'git hf release push',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf release push` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf release push');
