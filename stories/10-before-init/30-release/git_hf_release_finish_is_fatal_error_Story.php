...
//     when we run 'git hf release finish',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf release finish` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf release finish');
