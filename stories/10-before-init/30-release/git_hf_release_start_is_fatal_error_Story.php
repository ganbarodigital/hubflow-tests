...
//     when we run 'git hf release start',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf release start` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf release start');
