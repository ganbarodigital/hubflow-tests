...
//     we can run 'git hf feature list',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature list` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature list');
