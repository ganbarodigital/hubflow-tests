...
//     we can run 'git hf feature start',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature start` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature start');
