...
//     we can run 'git hf feature checkout',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature checkout` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature checkout');
