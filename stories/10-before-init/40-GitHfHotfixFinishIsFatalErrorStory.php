...
//     we can run 'git hf hotfix finish',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf hotfix finish` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf hotfix finish');
