...
//     when we run 'git hf release list',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf release list` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf release list');
