...
//     when we run 'git hf release cancel',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf release cancel` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf release cancel');
