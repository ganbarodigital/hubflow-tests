...
//     we can run 'git hf hotfix track',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf hotfix track` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf hotfix track');
