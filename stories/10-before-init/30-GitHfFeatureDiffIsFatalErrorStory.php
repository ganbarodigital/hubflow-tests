...
//     we can run 'git hf feature diff',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature diff` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature diff');
