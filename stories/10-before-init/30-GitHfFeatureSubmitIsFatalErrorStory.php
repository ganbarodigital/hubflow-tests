...
//     we can run 'git hf feature submit',
...
$story = newStoryFor("Hubflow")
         ...
         ->called("Running `git hf feature submit` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf feature submit');
