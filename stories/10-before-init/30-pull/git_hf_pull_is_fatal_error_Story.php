...
$story = newStoryFor("Hubflow")
         ->inGroup(["Before Initialisation", "git hf pull"])
         ->called("Running `git hf pull` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf pull');
