...
$story = newStoryFor("Hubflow")
         ->inGroup(["Before Initialisation", "git hf push"])
         ->called("Running `git hf push` results in fatal error")
...
$story->addAction(function() {
    ...
    $result = usingTestRepo()->runCommandAndIgnoreErrors('git hf push');
